module Elasticsearch
  module Rails
    module Instrumentation
      module Publishers
        # Wraps the `ScanRequest` methods to perform the instrumentation
        #
        # @see ScanRequest#execute_with_instrumentation!
